...
export const zh: Dict = {
  ...
  "topbar.push": "推送当前分支",
  // v0.13.21 — 推送下拉菜单中的几种 push 方式。
  "topbar.push.menu": "推送选项",
  "topbar.push.plain": "推送",
  "topbar.push.plainHint": "拒绝非快进推送",
  "topbar.push.lease": "Force-with-lease 推送",
  "topbar.push.leaseHint": "仅当远端自上次 fetch 后未变化时才覆盖",
  "topbar.push.force": "强制推送（无校验）",
  "topbar.push.forceHint": "无视远端是否有新提交都覆盖 —— 谨慎使用",
  "topbar.push.staleLease.title": "Lease 已过期 —— 远端已变化",
  "topbar.push.staleLease.message":
    "在你工作期间有别人向同一分支推送过。请先 fetch 拉取最新历史，确认无误后再重试推送。",
  "topbar.push.staleLease.fetch": "拉取并重试",
  "topbar.push.forceConfirm.title": "强制推送（不校验 lease）？",
  "topbar.push.forceConfirm.message":
    "这会无条件用本地版本覆盖远端分支。如果有别人在此期间推送过，他们的提交将丢失。除非你非常确定，否则优先选择 Force-with-lease。",
  "topbar.push.forceConfirm.confirmLabel": "强制推送",
  "topbar.search": "搜索",
  "topbar.settings": "设置",
  "topbar.menu": "菜单",
  ...
  "settings.graphMode": "历史 Graph",
  "settings.graphMode.normal": "完整",
  "settings.graphMode.compact": "紧凑",
  "settings.graphMode.hidden": "隐藏",
  ...
  "settings.signing.subtitle":
    "用 GPG 或 SSH 对每一次新提交（普通 / 合并 / rebase）签名。需要相应工具已安装且在 PATH 中；签名器通过现有的 user.signingkey 调用。",
  "settings.signing.enabled": "启用签名",
  "settings.signing.on": "开",
  "settings.signing.off": "关",
  "settings.signing.format": "格式",
  "settings.signing.format.openpgp": "OpenPGP (gpg)",
  "settings.signing.format.ssh": "SSH (ssh-keygen -Y sign)",
  "settings.signing.signingKey": "签名密钥",
  "settings.signing.signingKey.placeholderGpg": "密钥 ID / fingerprint（可选 — gpg 自动选默认）",
  "settings.signing.signingKey.placeholderSsh": "私钥文件路径，例如 ~/.ssh/id_ed25519",
  "settings.signing.gpgProgram": "gpg 程序",
  "settings.signing.sshProgram": "ssh-keygen 程序",
  "settings.signing.help":
    "留空则使用 git 默认值。SSH 签名需要 OpenSSH 8.0+。签名失败时提交会中止，工具栏会展示签名器的 stderr。",
  "settings.signing.savedEnabled": "已在 {scope} 配置开启提交签名。",
  "settings.signing.savedDisabled": "已在 {scope} 配置关闭提交签名。",
